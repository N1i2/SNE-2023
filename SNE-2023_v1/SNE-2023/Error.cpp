...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(105, "PARAMETERS: В файле -in слишком мало символов для работоспособной программы"),
		...
		ERROR_ENTRY(112,"LEXICAL: Не найден конец строкового литерала"),
		...
		ERROR_ENTRY(120,"LEXICAL: Неправильно объявление числового литерала в восьмерично предстовлении"),
		...
		ERROR_ENTRY(164,"SEMANTICS: К операндам типа text не применяются операторы"),
		ERROR_ENTRY(165,"SEMANTICS: Вложенные циклы не поддерживаются"),
		ERROR_ENTRY(166,"SEMANTICS: Параметры условного оператора должны быть числового типа"),
		ERROR_ENTRY(167,"SEMANTICS: Невозможно преобразовать строку в число"),
